...
def adicionar_nomes(lista_nomes):
...
def atualizar_nomes(lista_nomes):
    if verificar_lista_vazia(lista_nomes):
        print("\nA lista está vazia.")
        return
...
5- Sair
    ...
    opcao = int(input("Digite as opções acima: "))

    match opcao:
        case 1:
            adicionar_nomes(lista_nomes)
        case 2:
            mostrar_nomes(lista_nomes)
        case 3:
            atualizar_nomes(lista_nomes)
        case 4:
